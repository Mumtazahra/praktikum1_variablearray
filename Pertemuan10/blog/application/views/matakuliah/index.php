    ...
    <table border="1" class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                <a href=<?php echo base_url("index.php/matakuliah/edit/$mkh->id") ?>
                    class="btn btn-success btn-lg active">Edit</a>
                    &nbsp;
                    <a href=<?php echo base_url("index.php/matakuliah/delete/$mkh->id") ?>
                    class="btn btn-danger btn-lg active" onclick="return hapusMatakuliah('Anda yakin ingin menghapus matakuliah  <?php echo $mkh-> nama ?> ?')">Hapus</a>   
                </td>
            </tr>
            <?php
            $nomor++;
