    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url("index.php/tampil/jenis")?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url("index.php/tampil/index")?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url("index.php/tampil/katpes")?>" class="nav-link">
